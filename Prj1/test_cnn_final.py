...
def test_cnn_final_implementation():
    print("Testing FINAL CNN Architecture (CoordConv, Projection, Parallel)...")
    ...
    try:
        ...
        print(f"  Input Channels: {policy.input_channels} (Expect 6)")
        print(f"  Spatial Projection: {policy.spatial_proj}")
        print(f"  GAP Layer: {policy.gap}")
        print(f"  Local Branch: {policy.local_fc}")
